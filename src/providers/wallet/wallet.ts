  ...
  public getStatus(wallet: any, opts: any): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      let cacheBalance = (wallet: any, balance: any): void => {
        ...
        //STR    wallet.coin --> 'bstk' hardcode for unit
        cache.totalBalanceStr = this.txFormatProvider.formatAmountStr('bstk', cache.totalBalanceSat);
        cache.lockedBalanceStr = this.txFormatProvider.formatAmountStr('bstk', cache.lockedBalanceSat);
        cache.availableBalanceStr = this.txFormatProvider.formatAmountStr('bstk', cache.availableBalanceSat);
        cache.spendableBalanceStr = this.txFormatProvider.formatAmountStr('bstk', cache.spendableAmount);
        cache.pendingBalanceStr = this.txFormatProvider.formatAmountStr('bstk', cache.pendingAmount);
